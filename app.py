...
df = pd.read_csv(r'C:\Users\VAISHNAVI\Desktop\DiabetesPrediction\Dataset\diabetes.csv')


# HEADINGS
img=Image.open(r'C:\Users\VAISHNAVI\Desktop\DiabetesPrediction\Photo\Logo.png')
st.image(img)
...
st.subheader('Visualisation of the dataset')
st.bar_chart(df)
...
fig_preg = plt.figure()
ax1 = sns.scatterplot(x = 'Age', y = 'Pregnancies', data = df, hue = 'Outcome', palette = 'YlOrBr')
...
ax3 = sns.scatterplot(x = 'Age', y = 'Glucose', data = df, hue = 'Outcome' , palette='YlOrBr')
...
fig_bp = plt.figure()
ax5 = sns.scatterplot(x = 'Age', y = 'BloodPressure', data = df, hue = 'Outcome', palette='YlOrBr')
...
fig_i = plt.figure()
ax9 = sns.scatterplot(x = 'Age', y = 'Insulin', data = df, hue = 'Outcome', palette='YlOrBr')
...
fig_bmi = plt.figure()
ax11 = sns.scatterplot(x = 'Age', y = 'BMI', data = df, hue = 'Outcome', palette='YlOrBr')
...
st.write(str(round(accuracy_score(y_test, rf.predict(x_test))*100, 2))+'%')
